...
import {AlertController, Modal, Platform, NavController, ViewController, NavParams} from 'ionic-angular';
...
export class QuestionCardPage {
  static get parameters() {
    return [[NavController], [NavParams], [Platform], [QuestionsService], [PeopleService], [AlertController]];
  }

  constructor(nav, navParams, platform, questionsService, peopleService, alertCtrl) {   
    this.nav = nav;
  ...
  itemTapped(event, item) {
    if(this.page_type == 'text'){
      if ( item.uiHelper.hasAudio ) {
        let audio_alert = this.alertCtrl.create({
          title: 'Add audio',
        ...
        let video_alert = this.alertCtrl.create({
          title: 'Add video',
