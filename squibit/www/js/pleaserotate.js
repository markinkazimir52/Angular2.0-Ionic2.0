(function(){
    var PleaseRotate = {},
        ...
        // mobile devices need to have less than 768 pixels width, since that is when desktop-mode becomes effective
        // this is done to handle tablets that do not report unique UserAgent strings
        isMobile = ((/Android|iPhone|iPad|iPod|IEMobile|Opera Mini/i.test(navigator.userAgent)) && (document.documentElement.clientWidth < 768)),
        init = false;
    ...
    function isPortrait(){
        // removed old portrait detection code - viewport sizing only
        // reason: keyboard display on screen would cause viewport to change size... and thus overlay to show :-(
        //return ( window.innerWidth < window.innerHeight);
        
        // new method: use actual orientation property
        // note: orientation is +/- 90 for landscape, 0 for portrait
